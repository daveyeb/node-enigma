# node-enigma ![workflow status](https://github.com/daveyeb/node-enigma/actions/workflows/ci.yml/badge.svg) ![NPM Downloads](https://img.shields.io/npm/d18m/node-enigma?label=installs)
