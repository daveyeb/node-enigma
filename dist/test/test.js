...
describe("Instantiation", function () {
    describe("intantiating with invalid rotor", function () {
        it("should throw a config error", function () {
            expect(() => (0, index_1.enigma)({
                rotors: ["ii", "iii", "ukwb"],
                reflector: "",
            })).to.throw("Invalid rotor: ukwb. Valid rotors: I, II, III, IV, V, VI, VII, VIII, BETA, GAMMA");
        });
    });
    describe("intantiating with invalid rotor", function () {
        it("should throw a config error", function () {
            expect(() => (0, index_1.enigma)({
                rotors: ["ii", "iii"],
                reflector: "ukwb",
            })).to.throw("Invalid number of rotors, should be 3 or 4. Selected rotors: ii,iii");
        });
    });
    describe("instantiating with wrong config", function () {
        it("should throw a config error", function () {
            expect(() => (0, index_1.enigma)({
                ...
                reflector: "ukwb",
            })).to.throw("Invalid rotor: alpha. Valid rotors: I, II, III, IV, V, VI, VII, VIII, BETA, GAMMA");
        });
    });
});
describe("Encoding plaintext with whitespaces/illegal characters", function () {
    describe("Plaintext with whitespaces", function () {
        it("should initialize an Enigma m3 instance", function () {
            var machine = (0, index_1.enigma)({
                rotors: ["i", "ii", "iii"],
                reflector: "ukwc",
            });
            var result = (0, index_1.encode)(machine, "I LOVE FISHES");
    ...
    describe("Plaintext with illegal characters", function () {
        it("should initialize an Enigma m3 instance", function () {
            ...
            var result = (0, index_1.encode)(machine, "ILOVE*/?FISHES");
...
describe("Enigma M3", function () {
    ...
    describe(".encode", function () {
        it("should encode message with default setting", function () {
            ...
            var result = (0, index_1.encode)(machine, "ILOVEFISHES");
    ...
    describe(".decode", function () {
        it("should decode message with default setting", function () {
            ...
            var result = (0, index_1.decode)(machine, "UUUJGGOCWJM");
...
describe("Enigma M4", function () {
    ...
    describe(".encode", function () {
        it("should encode message with default setting 2", function () {
            ...
            var result = (0, index_1.decode)(machine, "ILOVEFISHES");
